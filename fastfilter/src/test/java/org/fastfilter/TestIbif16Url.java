...
public class TestIbif16Url {
 ...
 private static double fpp_final;
    ...
    public static void main(String... args) {
        ...
        */
        ...
        for (int size = 1; size <= 100; size++) {
            System.out.println("size " + size);
            test(TestFilterType.XOR_BINARY_FUSE_16_BLOOM, size, size, 0, true);
        }
        /*
        ...
        //for (int test = 0; test <= 40; test += 4){  
          ...
          // for (int size = 10_100_000; size <= 10_800_000; size += 100_000) {
           ...
           // for (int size = 11_000_000; size <= 12_000_000; size += 200_000) {
                ...
                //testAll(size, true);
                int test = 0;
                test(TestFilterType.XOR_BINARY_FUSE_16_BLOOM, size, size, test, true);
    ...
    private static void testAll(int len1, int len2, boolean log) {
       TestFilterType type = TestFilterType.XOR_BINARY_FUSE_16_BLOOM;
