 ...
 */
public class Xor15BloomV2 implements Filter {
    ...
    public static Xor15BloomV2 construct(long[] keys, long[] keysBloom) {
        return new Xor15BloomV2(keys, keysBloom);
    }

    public Xor15BloomV2(long[] keys, long[] keysBloom) {
