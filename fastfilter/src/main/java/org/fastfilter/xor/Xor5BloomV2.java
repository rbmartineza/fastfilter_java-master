 ...
 */
public class Xor5BloomV2 implements Filter {

    private static final int BITS_PER_FINGERPRINT = 5;
    private static final int HASHES = 3;
    //private static final int FACTOR_TIMES_100 = 123;
    private static final int FACTOR_TIMES_100 = 100;  // Modify to check the FPP degradation
    ...
    public static Xor5BloomV2 construct(long[] keys, long[] keysBloom) {
        return new Xor5BloomV2(keys, keysBloom);
    }

    public Xor5BloomV2(long[] keys, long[] keysBloom) {
...
// Add keys on the Bloom Filter after complete the insertions on the Xor Filter
    ...
    public Xor5BloomV2(InputStream in) {
        try {
