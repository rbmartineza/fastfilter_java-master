 ...
 */
public class Xor8BloomV3 implements Filter {

    private static final int BITS_PER_FINGERPRINT = 7;
    private static final int HASHES = 3;
    private static final int FACTOR_TIMES_100 = 105;
    ...
    public static Xor8BloomV3 construct(long[] keys, long[] keysBloom) {
        return new Xor8BloomV3(keys, keysBloom);
    }

    public Xor8BloomV3(long[] keys, long[] keysBloom) {
...
// Add keys on the Bloom Filter after complete the insertions on the Xor Filter
    ...
    public Xor8BloomV3(InputStream in) {
        try {
