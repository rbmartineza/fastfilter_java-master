 ...
 */
public class Xor15BloomV3 implements Filter {
    ...
    public static Xor15BloomV3 construct(long[] keys, long[] keysBloom) {
        return new Xor15BloomV3(keys, keysBloom);
    }

    public Xor15BloomV3(long[] keys, long[] keysBloom) {
