 ...
 */
public class Xor8BloomV3_1 implements Filter {
    ...
    private static final int FACTOR_TIMES_100 = 100;    // it can be changed
    ...
    public static Xor8BloomV3_1 construct(long[] keys, long[] keysBloom, int alpha) {
        return new Xor8BloomV3_1(keys, keysBloom, alpha);
    }

    public Xor8BloomV3_1(long[] keys, long[] keysBloom, int alpha) {
