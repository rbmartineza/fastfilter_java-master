 ...
 */
public class XorBinaryFuse8Bloom implements Filter {
    ...
    public XorBinaryFuse8Bloom(int segmentCount, int segmentLength) {
    ...
    public static XorBinaryFuse8Bloom construct(long[] keys) {
        ...
        XorBinaryFuse8Bloom filter = new XorBinaryFuse8Bloom(segmentCount, segmentLength);
        filter.addAll(keys);
        return filter;
    }
