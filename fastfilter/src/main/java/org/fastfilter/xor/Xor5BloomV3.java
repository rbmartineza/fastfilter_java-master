 ...
 */
public class Xor5BloomV3 implements Filter {
    ...
    public static Xor5BloomV3 construct(long[] keys, long[] keysBloom) {
        return new Xor5BloomV3(keys, keysBloom);
    }

    public Xor5BloomV3(long[] keys, long[] keysBloom) {
...
// Add keys on the Bloom Filter after complete the insertions on the Xor Filter
    ...
    public Xor5BloomV3(InputStream in) {
        try {
