 ...
 */
public class Ibif16 implements Filter {
    ...
    public Ibif16(int segmentCount, int segmentLength) {
    ...
    public static Ibif16 construct(long[] keys) {
        ...
        Ibif16 filter = new Ibif16(segmentCount, segmentLength);
        filter.addAll(keys);
        return filter;
    }
