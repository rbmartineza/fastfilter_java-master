 ...
 */
public class Xor15BloomV4 implements Filter {

    private static final int BITS_PER_FINGERPRINT = 15;
    private static final int HASHES = 3;
    private static final int FACTOR_TIMES_100 = 120;
    ...
    public static Xor15BloomV4 construct(long[] keys, long[] keysBloom) {
        return new Xor15BloomV4(keys, keysBloom);
    }

    public Xor15BloomV4(long[] keys, long[] keysBloom) {
...
// Add keys on the Bloom Filter after complete the insertions on the Xor Filter
    ...
    /*
    public Xor15BloomV4(InputStream in) {
        try {
