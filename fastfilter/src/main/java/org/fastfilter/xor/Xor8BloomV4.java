 ...
 */
public class Xor8BloomV4 implements Filter {
    ...
    public static Xor8BloomV4 construct(long[] keys, long[] keysBloom) {
        return new Xor8BloomV4(keys, keysBloom);
    }

    public Xor8BloomV4(long[] keys, long[] keysBloom) {
...
// Add keys on the Bloom Filter after complete the insertions on the Xor Filter
    ...
    public Xor8BloomV4(InputStream in) {
        try {
